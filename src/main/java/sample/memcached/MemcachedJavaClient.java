...
/**
 * Lets say you have 3 servers.
 * Server 1 and server 2 have 3GB of space and server 3 has 2GB of space for cache.
 * Here is how I would set up my client.
 */
public class MemcachedJavaClient {
	...
	static {
		...
		// and set the max idle time for a conn to 6 hours
		//
		pool.setInitConn(5);
		pool.setMinConn(5);
		pool.setMaxConn(250);
